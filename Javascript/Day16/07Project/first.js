...
form.addEventListener('submit',(e)=>{
    ...
    const text=`Hii ${fname} ${surname}, Your Zoadic sign is ${zodiacSigns[month-1]} . ${compliments[dob-1]}.${victimCardCompliments[year%20]}. ${recommendations[(dob*month)%30]} . ${predictions[(name.length)%10]}`;
